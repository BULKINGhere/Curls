...
def start_curl(pose):
      ...
      while cap.isOpened():
        ...
        # Rep data
            ...
            cv2.putText(image, str(counter_left), (10,60), cv2.FONT_ITALIC, 2, (255,255,255), 2, cv2.LINE_AA)
        

            cv2.putText(image, 'REPS', (15,40), cv2.FONT_ITALIC, 0.5, (0,0,0), 1, cv2.LINE_AA)
            cv2.putText(image, str(counter_right), (20,60), cv2.FONT_ITALIC, 2, (255,255,255), 2, cv2.LINE_AA)
